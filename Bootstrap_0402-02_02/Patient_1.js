...
Ivanov.setById();
let Petrov = new Patient('Петров', 'Петр', 'Петрович', new Date(1969, 5, 9), "м", "Медотвод");
Petrov.setById();
let Sidorov = new Patient('Сидоров', 'Сидор', 'Степанович', new Date(1995, 7, 1), "м", "Исполнено");
Sidorov.setById();